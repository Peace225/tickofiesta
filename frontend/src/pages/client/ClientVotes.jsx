    ...
    <div className="p-4 md:p-8 animate-in fade-in duration-500 max-w-lg mx-auto lg:max-w-4xl">
      <div className="mb-8">
        <h1 className={`text-3xl font-black tracking-tighter flex items-center gap-2 ${theme.text}`}>
          <Zap className="text-[#f5a623]" /> Mes Votes
        </h1>
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        <div className={`p-5 rounded-3xl border ${theme.card}`}>
          <p className={`text-[10px] font-black uppercase tracking-widest mb-1 ${theme.sub}`}>Candidats Soutenus</p>
          <p className={`text-3xl font-black ${theme.text}`}>0</p>
        </div>
      </div>
      ...
      <div className={`flex flex-col items-center justify-center py-16 rounded-[2rem] border border-dashed ${theme.card}`}>
        ...
        <p className={`text-sm font-black ${theme.text}`}>Tu n'as participé à aucun vote récent.</p>
        <button className="mt-4 px-6 py-2 rounded-full bg-[#f5a623]/10 text-[#f5a623] text-[10px] font-black uppercase tracking-widest hover:bg-[#f5a623] hover:text-white transition-all">
